      ...
      <section className="section contact-section">
        <div className="shell contact-grid">
          <div className="contact-details">
            ...
            <address className="contact-method"><span>Office</span><strong>{site.address.streetAddress}</strong><small>{site.address.addressLocality} {site.address.postalCode}</small></address>
