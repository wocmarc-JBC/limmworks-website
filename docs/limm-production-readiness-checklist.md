# LIMM Production Readiness Checklist
...
- [ ] Service page image choices reviewed.
- [ ] Gallery image choices reviewed.
- [ ] Owner's Notes reviewed and approved.
- [ ] Service copy reviewed and approved.
...
- [ ] No Wix replacement until Marcus approves.
- [ ] No `limmworks.com` domain connection until Marcus approves.
- [ ] No DNS change until Marcus approves.
